package lan.chaos.java.io.nio.multiplexing;
...
public class SocketServer2 {
    ...
    private static void readSocketChannel(SelectionKey readyKey) throws Exception {
        ...
        if (URLDecoder.decode(message.toString(), "UTF-8").indexOf("over") != -1) {
            ...
            log.info("端口:" + resoucePort + "客户端发来的完整信息======completeMessage : " + URLDecoder.decode(completeMessage.toString(), "UTF-8"));
            ...
            log.info("端口:" + resoucePort + "客户端信息还未接受完，继续接受======message : " + URLDecoder.decode(message.toString(), "UTF-8"));
