...
cd jdk21-platform
# 编译 + 跑全部单元测试（离线）
mvn -o -pl jdk21-base test

# 仅跑单个特性测试
mvn -o -pl jdk21-base test -Dtest=VirtualThreadDemoTest

# 控制台分节打印所有特性演示
mvn -o -pl jdk21-base compile exec:java -Dexec.mainClass=lan.chaos.jdk21features.NewFeaturesApp
```
